...
export function shouldFail(
  ...
  return result.findings.some(
    (finding) => severityRank[finding.severity] >= minimum
  );
}

export function isFailThreshold(value: string): value is FailThreshold {
  return value === "never" || severities.includes(value as Severity);
}
